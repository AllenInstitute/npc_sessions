...
class DynamicRoutingSession:
    ...
    def nwb(self) -> pynwb.NWBFile:
        nwb = pynwb.NWBFile(
            ...
            # processing=tuple(self.processing.values()), # unsupported, makes hdf5 NWB file unreadable
    ...
    def processing(
        ...
        `acquisition`.
        """
        #! keep code in-sync with def nwb(self) - NWB cannot use these processing modules
