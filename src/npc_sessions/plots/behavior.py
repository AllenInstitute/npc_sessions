...
def plot_performance_by_block(session: 'npc_sessions.DynamicRoutingSession') -> plt.Figure:
...
def plot_first_lick_latency_hist(session: 'npc_sessions.DynamicRoutingSession') -> plt.Figure:
