...
def plot_barcode_intervals(session: 'npc_sessions.DynamicRoutingSession'):
    ...
    sync_max_deviation_string =  plot_utils.add_valence_to_string(f'Sync deviation: {sync_max_deviation_from_median_interval}',
    ...
    for device_name, device_data in device_barcode_dict.items():
        ...
        max_deviation_string =  plot_utils.add_valence_to_string(f'{device_name}: {max_deviation}',
                                                            max_deviation,
                                                            max_deviation<0.001,
                                                            max_deviation>0.001)
